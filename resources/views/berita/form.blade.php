...
<div class="form-group row">
 ...
 <div class="form-group row">
        <label form ="berita_id" class="col-md-4 col-form-label text-md-right">{{ __('berita_id') }}</label>

        <div class="col-md-6">
            <input id="berita_id" type="text" class="form-control @error('berita_id') is-invalid @enderror" name="berita_id" value="{{ old('berita_id') }}" required autofocus>
